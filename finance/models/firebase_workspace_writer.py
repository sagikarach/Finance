    ...
    def upsert_movement(self, movement: BankMovement) -> None:
        ...
        fs.upsert_document(
            ...
            fields={
                ...
                "transfer_from": getattr(movement, "transfer_from", None),
                "transfer_to": getattr(movement, "transfer_to", None),
                "deleted": False,
                "source": "desktop",
            },
        )
    ...
    def upsert_movements_bulk(
        ...
        for m in items:
            ...
            fields = {
                ...
                "transfer_from": getattr(m, "transfer_from", None),
                "transfer_to": getattr(m, "transfer_to", None),
                "deleted": False,
                "source": "desktop",
                "updated_at": now,
